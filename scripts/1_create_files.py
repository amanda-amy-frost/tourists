...
COUNTRY_ISO_CODES = sorted(pop.unique(subset='iso_code').get_column('iso_code').to_list())
...
with open('../data/climate-data.csv', 'w', newline='\n') as f:
    ...
    for iso_code in COUNTRY_ISO_CODES:
        ...
        climate_link = f'https://cckpapi.worldbank.org/api/v1/era5-x0.25_timeseries_hd30_timeseries_annual_1950-2023_mean_historical_era5_x0.25_mean/{iso_code}?_format=json'
